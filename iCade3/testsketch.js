...
function setup() {
  var canvas = createCanvas(1100, 1450);
  ...
  highScore1EmailInput.id("highScore1EmailInput");
  highScore1NameInput.id("highScore1NameInput");
  highScore2EmailInput.id("highScore2EmailInput");
  highScore2NameInput.id("highScore2NameInput");
...
function introPage(){
  ...
  rect(20,650,3,3); rect(323,697,3,3); rect(1100,1290,3,3); rect(1168,650,3,3); rect(934,970,3,3); rect(942,790,3,3); rect(1124,1200,3,3); rect(809,737,3,3); rect(522,945,3,3); rect(932,1200,3,3);
  rect(1054,1270,3,3); rect(69,1055,3,3); rect(440,850,3,3); rect(250,810,3,3); rect(800,830,3,3); rect(1048,720,3,3); rect(756,970,3,3); rect(400,950,3,3); rect(452,650,3,3); rect(854,1230,3,3);
  rect(800,660,3,3); rect(454,750,3,3); rect(200,737,3,3); rect(239,512,3,3); rect(239,930,3,3); rect(690,920,3,3); rect(1130,830,3,3); rect(756,970,3,3); rect(1036,950,3,3); rect(634,780,3,3); 
  rect(452,1160,3,3); rect(630,890,3,3); rect(700,650,3,3); rect(1124,980,3,3); rect(241,582,3,3); rect(54,1223,3,3); rect(100,930,3,3); rect(54,750,3,3); rect(173,1250,3,3); rect(567,1090,3,3);
  textSize(20);
  fill(random(0,255))
  imageMode(CENTER);
  ...
  image(sbLogo, 550, 600, 375, 100);
  text("Click to Begin", 480, 720);
  image(potImages[(currentPotFrame) % numPotFrames], 540, 800, 75, 75);
...
function mouseClicked(){
  ...
  if (gameState === 2 && mouseX > 790 && mouseX < 830 && mouseY > 10 && mouseY < 50){
    gameState = 3;
   }

  else if (gameState === 2 && leftyMode === true && mouseX > 315 && mouseX < 405 && mouseY > 525 && mouseY < 615){
      var laser = new Laser(ship.x, 1185); 
      lasers.push(laser); 
      laserSound.play();
   }

  else if (gameState === 2 && leftyMode === false && mouseX > 685 && mouseX < 775 && mouseY > 525 && mouseY < 615){
        var laser = new Laser(ship.x, 1185); 
        lasers.push(laser); 
        laserSound.play();
      }
...
function mousePressed(){
   ...
   else if(gameState === 2 && leftyMode === true && mouseIsPressed && mouseX > 640 && mouseX < 715 && mouseY > 1280 && mouseY < 1360 ){
    ship.setDir(-1);
   }

   else if (gameState === 2 && leftyMode === true && mouseIsPressed && mouseX > 740 && mouseX < 815 && mouseY > 1280 && mouseY < 1360){
    ship.setDir(1);

  }

  if (gameState === 2 && leftyMode === true && mouseIsPressed && mouseX > 320 && mouseX < 395 && mouseY > 1280 && mouseY < 1360){
      var laser = new Laser(ship.x, 1185); 
      lasers.push(laser); 
      laserSound.play();
   }

  else if (gameState === 2 && leftyMode === false && mouseIsPressed && mouseX > 245 && mouseX < 330 && mouseY > 1280 && mouseY < 1360){
        ship.setDir(-1);
  }
  
  else if (gameState === 2 && leftyMode === false && mouseIsPressed && mouseX > 350 && mouseX < 430 && mouseY > 1280 && mouseY < 1360){ //this may need to be an else if
        ship.setDir(1);
  }

  if (gameState === 2 && leftyMode === false && mouseIsPressed && mouseX > 710 && mouseX < 790 && mouseY > 1280 && mouseY < 1360){
        var laser = new Laser(ship.x, 1185); 
        lasers.push(laser); 
        laserSound.play();
      }
   ...
   else if (gameState === 10 && mouseX > 475 && mouseX < 525 && mouseY > 340 && mouseY < 370 && mouseIsPressed){
    preload();
    setup();
   }
...
function startGame(){
  ...
  if (ship.x < 0 || ship.x > 1100){
   ...
   image(leftButton, 680, 1320, 75, 75);
   image(rightButton, 780, 1320, 75, 75);
   image(fireButton, 360, 1320, 75, 75);
  }

  else if (leftyMode === false){ // if its not in lefty mode draw and assign to right handed
   image(leftButton, 290, 1320, 75, 75);
   image(rightButton, 390, 1320, 75, 75);
   image(fireButton, 750, 1320, 75, 75);
  }
  ...
  fill(255);
  text(level, 980, height-40);
  text(score, 576, height-40);
  fill(100,255,100);
  text("SCORE:", 470, height-40);
  fill(255);
  textSize(18);
  //text("MOBILE:", 845, 40);
  ...
  image(sbLogo, 570, 33, 150, 40);

  image(speakerOff, 710, 30, 40, 40);
  image(speakerOn, 760, 30, 40, 40);
  image(pauseButton, 810, 30, 40, 40); 



  //MOBILE CONTROLLER

  image(leftyButton, 865, 30, 50, 50);
  image(rightyButton, 915, 30, 50, 50);
 ...
 // BUTTONS
  ...
  if (mouseIsPressed && mouseX > 690 && mouseX < 730 && mouseY > 10 && mouseY < 50){
    volume = 0.0;   
    fill(255);
    ellipse(710,30,30,30);
  }

  if (mouseIsPressed && mouseX > 740 && mouseX < 780 && mouseY > 10 && mouseY < 50){
    volume = 1.0;
    fill(255);
    ellipse(760,30,30,30);
  }

   if (mouseIsPressed && mouseX > 840 && mouseX < 890 && mouseY > 10 && mouseY < 60){
     leftyMode = true;
    // 
  }

  if (mouseIsPressed && mouseX > 890 && mouseX < 940 && mouseY > 10 && mouseY < 60){
    // right mode
    leftyMode = false;
  }
...
for (var i = 0; i < bonusShooterLasers.length; i++){
  ...
  bonusShooterLasers[i].move();
   if (bonusShooterLasers[i].hitsShip(ship)) {
    ...
    if (bonusShooterLasers[i].y > 1450) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
...
for (var i = 0; i < enemyLasers.length; i++){
  ...
  enemyLasers[i].move();
     ...
     if (enemyLasers[i].y > 1450) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
 ...
 var edge = false; 
  ...
  // COUNTER INITIATED EVENTS
    ...
    if (counter > 6 && counter < 7){
      //alienLaser.play();
       var enemyLaser = new EnemyLaser(chaser.x + random(0,550), chaser.y + random(0,232)); //create new Laser obj at the current x coord (from the center) of ship and bottom of screen (?) 
...
if (edge1){
  ...
  for (var i = 0; i < greenAliens.length; i++) { //function that actually shows and moves the alien array
    ...
    if (greenAliens[i].y > 650) { //if alienarray OBJ x value is greater than width && alienarray x pos is less than 0
      greenAliens[i].stoned(); //then edge is there and becomes true
    }
    if (greenAliens[i].y > 1100) { //if alienarray OBJ x value is greater than width && alienarray x pos is less than 0
  ...
  for (var i = 0; i < pinkAliens.length; i++) { //function that actually shows and moves the alien array
    ...
    if (pinkAliens[i].y > 650) { //if alienarray OBJ x value is greater than width && alienarray x pos is less than 0
      pinkAliens[i].stoned(); //then edge is there and becomes true
    }
    if (pinkAliens[i].y > 1100){
      gameState = 6;
    }
  }
  ...
  for (var i = 0; i < blueAliens.length; i++) { //function that actually shows and moves the alien array
    ...
    if (blueAliens[i].y > 650) { //if alienarray OBJ x value is greater than width && alienarray x pos is less than 0
      blueAliens[i].stoned(); //then edge is there and becomes true
    }
    if (blueAliens[i].y > 1100){
      gameState = 6;
    }
  }
  ...
  for (var i = 0; i < yellowAliens.length; i++) { //function that actually shows and moves the alien array
    ...
    if (yellowAliens[i].y > 650) { //if alienarray OBJ x value is greater than width && alienarray x pos is less than 0
      yellowAliens[i].stoned(); //then edge is there and becomes true
    }

    if (yellowAliens[i].y > 1100){
      gameState = 6;
    }
  }
...
function highScore1page(){
  ...
  //input rollover
    ...
    highScore1EmailInput.position(310,323);
...
function highScore2page(){
  ...
  //input rollover
    ...
    highScore2EmailInput.position(310,323);
...
function keyPressed() {
  ...
  else if (keyCode === 67 || keyCode === 81) { // C or Q - which are left and right released 
    ship.setDir(0);
  }

  else if (key === ' ') { //if keycode equals spacebar 
    var laser = new Laser(ship.x, ship.y); //create new Laser obj at the current x coord (from the center) of ship and bottom of screen (?)
    lasers.push(laser); //pushes another drop into current lasers array
    laserSound.play();
  }

  else if (keyCode === 85 || keyCode === 73 || keyCode === 89 || keyCode === 72 || keyCode === 74 || keyCode === 75) { //if keycode equals spacebar 
    var laser = new Laser(ship.x, ship.y); //create new Laser obj at the current x coord (from the center) of ship and bottom of screen (?)
    lasers.push(laser); //pushes another drop into current lasers array
    laserSound.play();
  }
...
function copRelocate(){
  bonusShooter.y = random(100,850);
}

function copClear(){
  bonusShooter.y = random(0,850);
  bonusShooter.x = width + 50;
}

function anotherCop(){
 bonusShooter = new BonusShooter(0, random(100,850), xdirCop); 
}
...
function shipHit(){
  ...
  if (playing === true) { 
    image(fireImage, ship.x, ship.y, 500 , 500);
    gameState = 9;
 }
...
function resetSketch(){
  ...
  xdir = xdir + 0.06;
  xdirCop = xdirCop + 0.3;
  chaser = new Chaser(335,145, xdir);
  bonusShooter = new BonusShooter(0, random(100,850), xdirCop);
  ...
  for (var i = 0; i < 10; i++) {  //while i is less than 10 in alien array iterate through array
    greenAliens[i] = new GreenAlien(i*55+360, 170, xdir); //for each alien in array, create a new alien object at i and 60 starting
  }
  for (var i = 0; i < 10; i++) {  //while i is less than 10 in alien array iterate through array
    pinkAliens[i] = new PinkAlien(i*55+360, 230, xdir); //for each alien in array, create a new alien object at i and 60 starting

  }
  for (var i = 0; i < 10; i++) {  //while i is less than 10 in alien array iterate through array
    blueAliens[i] = new BlueAlien(i*55+360, 290, xdir); //for each alien in array, create a new alien object at i and 60 starting

  }
  for (var i = 0; i < 10; i++) {  //while i is less than 10 in alien array iterate through array
    yellowAliens[i] = new YellowAlien(i*55+360, 350, xdir); //for each alien in array, create a new alien object at i and 60 starting
...
function gameOver() { //the only reason x,y are the only parameters is because they are the only perameters that will change throughout us
    ...
    fill(0);
    rect(0,0, 1100, 623);
    image(gameOverBack, width/2,310,1100,623);
    fill(0);
    rect(0,620,1100,6);
    fill(255);
    textSize(24);
  ...
  if(frameCount % 8 == 0){
    ...
    nameInput.position(200, 225);
    emailInput.position(200,260);
    fill(255,0,0);
    textSize(12);
...
function EnemyLaser(x, y) {
  ...
  this.r = 4; //initializing object radius to 
  ...
  if (d3 < 60 ) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
      return true; //return true value (to delete alien)
    } else { // if else
      return false; //stay false (so alien remains there and nothing happens to it)
    }
  ...
  this.move = function() {
    this.y = this.y + 12; //move function for the y value of the laser, the y value equals its current value - 5 px 
  }
...
function GreenAlien(x, y, xdir) { //the only reason x,y are the only parameters is because they are the only perameters that will change throughout use
  this.x = x; //intializing x pos of alien obj
  this.y = y; // intializing y pos of alien object
  this.r = 50; //declaring the radius of the ellipse object
  this.toDelete = false;
  this.xdir = xdir; //delcaring speed as xdir, just 1
  ...
  this.stoned = function(){
    fill(255,0,0,100);
    rect(this.x - 10, this.y - 15, 20, 24);
  }
...
function Ship() {
  ...
  this.show = function() { //this function will actually show the object
    imageMode(CENTER);
    image(this.img, this.x, this.y, 120, 120); // the x coordinates is the current x value, -20 from the height (bottom) and 20px by 60px
  }
  ...
  this.move = function(dir) { //assings move method to the ship object, the dir parameter is something that will constantly be changing
     this.x += this.xdir*15; //the current x pos + current x pos and x speed *5
  }
...
function NewLife() {
  ...
  this.show = function(lives) { //this function will actually show the object
    textSize(30);
    fill(255);
    text(this.lives - 1, 230, height-40);
    fill(100,255,100);
    text("Lives:", 140, height-40);
    image(this.img, 100, height-50, 50, 50);
  }
...
function Laser(x, y) {
  ...
  if (d < 25) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
    image(this.greenPop, this.x, this.y, 50, 50);
      return true; //return true value (to delete alien)
    } else { // if else
      return false; //stay false (so alien remains there and nothing happens to it)
    }
   ...
   if (d1 < 25) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
      image(this.pinkPop, this.x, this.y, 50, 50);
      return true; //return true value (to delete alien)
    } else { // if else
      return false; //stay false (so alien remains there and nothing happens to it)
    }
  ...
  if (d2 < 25) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
     image(this.bluePop, this.x, this.y, 50, 50);
      return true; //return true value (to delete alien)
    } else { // if else
      return false; //stay false (so alien remains there and nothing happens to it)
    }
  ...
  if (d3 < 25) { //if the distance between the laser and alien is less than the radius of laser + the radius of the alien
      image(this.yellowPop, this.x, this.y, 50, 50);
      return true; //return true value (to delete alien)
    } else { // if else
      return false; //stay false (so alien remains there and nothing happens to it)
    }
  ...
  this.move = function() {
    this.y = this.y - 15; //move function for the y value of the laser, the y value equals its current value - 5 px 
  }
...
function BonusShooter(x, y, xdirCop) { //the only reason x,y are the only parameters is because they are the only perameters that will change throughout use
  this.x = x; //intializing x pos of alien obj
  this.y = y; // intializing y pos of alien object
  this.r = 80; //declaring the radius of the ellipse object
  this.toDelete = false;
  ...
  this.show = function() { //method to display the aliens
    //if(frameCount % 3 == 0) {
    imageMode(CENTER);
    image(this.img[(currentCopFrame) % numCopFrames], this.x, this.y, this.r, 48);
    //}
  }
...
function Base (x,y, baseRadius){
 ...
 this.smokeWeed = function(){
    image(this.smoking[(currentSmokeFrame) % numSmokeFrames], this.x, this.y, 200, 200);
}
