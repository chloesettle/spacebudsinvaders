...
function startGame(){
  ...
  if (leftyMode === true){ // if its in lefty mode draw and assign functionality to left handed controls
   ...
   image(fireButton, 360, 575, 55, 55);
        ...
        if (mouseIsPressed && mouseX > 645 && mouseX < 715 && mouseY > 545 && mouseY < 605){
         ship.setDir(-1);
        }
  
        if (mouseIsPressed && mouseX > 725 && mouseX < 795 && mouseY > 545 && mouseY < 605){ //this may need to be an else if
          ship.setDir(1);
        }

        if (mouseIsPressed && mouseX > 325 && mouseX < 395 && mouseY > 545 && mouseY < 605){
   ...
   image(fireButton, 750, 575, 55, 55);
       ...
       if (mouseIsPressed && mouseX > 275 && mouseX < 345 && mouseY > 545 && mouseY < 605){
        ship.setDir(-1);
      }
  
      if (mouseIsPressed && mouseX > 355 && mouseX < 425 && mouseY > 545 && mouseY < 605){ //this may need to be an else if
        ship.setDir(1);
      }

      if (mouseIsPressed && mouseX > 715 && mouseX < 785 && mouseY > 545 && mouseY < 605){
        var laser = new Laser(ship.x, 510); //create new Laser obj at the current x coord (from the center) of ship and bottom of screen (?)
        lasers.push(laser); //pushes another drop into current lasers array
        laserSound.play();
      }
...
if (score > 0 && score < 100000 && frameCount % 8 == 0){
    missionStatus = targetScore0;
}

if (score > 100001 && score < 200000 && frameCount % 8 == 0){
    missionStatus = targetScore1;
  }

if (score > 200001 && score < 300000 && frameCount % 8 == 0){
    missionStatus = targetScore2;
}

if (score > 300001 && score < 420000 && frameCount % 8 == 0){
    missionStatus = targetScore3;
}

if (score > 420001 && score < 600000 && frameCount % 8 == 0){
    missionStatus = targetScore4;
}

if (score > 600001 && score < 700000 && frameCount % 8 == 0){
    missionStatus = targetScore5;
}

if (score > 700001 && score < 800000 && frameCount % 8 == 0){
    missionStatus = targetScore6;
}

if (score > 800001 && score < 900000 && frameCount % 8 == 0){
    missionStatus = targetScore7;
}

if (score > 900001 && score < 1000000 && frameCount % 8 == 0){
    missionStatus = targetScore8;
}

if (score > 1000001 && frameCount % 8 == 0){
...
function highScore1page(){
  ...
  image(potImages[(currentPotFrame) % numPotFrames], 546, 334, 60, 60);
    ...
    highScore1EmailInput.position(490,400);
...
function highScore2page(){
  ...
  image(potImages[(currentPotFrame) % numPotFrames], 546, 334, 60, 60);
    ...
    highScore2EmailInput.position(490,400);
...
function submitPage(){
    ...
    text("Submitted! Play Again?", 490, 250);
    image(yesButton, 520, 340, 100, 60);
    image(noButton, 650, 340, 100, 60);
 ...
 /* if (mouseX > 335 && mouseX < 420 && mouseY > 480 && mouseY < 515){
  ...
  /*else if (mouseX > 335 && mouseX < 420 && mouseY > 480 && mouseY < 515){
    stroke(255);
    strokeWeight(2);
    fill(255);
    rect(530,340,85,35);
