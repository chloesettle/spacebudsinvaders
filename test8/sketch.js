...
function preload(){
  ...
  gameOverBack = loadImage("gameOverBack.png");
}
...
function setup() {
  ...
  xdir = 0.6;
  xdirCop = 1;
  highScoreColor1 = color(100,100,100);
  highScoreColor2 = color(100,100,100);
...
function startGame(){
  ...
  fill(100,255,100);
  text("Score:", 850, 40);
  text("Mission Status:", 120, 40);
  fill(highScoreColor1);
  text("Target Score: ", 270, 40);
  fill(highScoreColor2);
  text("Target Score: ", 500, 40);
  fill(255);
...
function highScore1page(){
  ...
  image(highScore1Image, 550, 290, 600, 350);
  //fake button
  noStroke();
  rect(720,405, 75, 30);
  ...
  strokeWeight(0);
  textSize(20);
  fill(100,255,0, random(0,255));
  text("420,000", 510, 170);
  fill(255,255,255, random(0,255));
  text("YOU HAVE WON A DEAL!", 455, 283);
  fill(255);
  text("INITIALS", 405, 397);
  text("EMAIL", 405, 427);
  fill(255);
  //text(mouseX + "," + mouseY, 510, 395);
  stroke(255);

  image(potImages[(currentPotFrame) % numPotFrames], 546, 334, 60, 60);

    highScore1NameInput.position(485, 385);
    highScore1NameInput.style('background-color', '#000000');
    highScore1NameInput.style('font-size', '24px');
    highScore1NameInput.style('color', '#ffffff');
    highScore1NameInput.style('font-family', 'VT323','monospace');
    highScore1EmailInput.position(485,415);
    highScore1EmailInput.style('background-color', '#000000');
    highScore1EmailInput.style('font-family', 'VT323','monospace');
    highScore1EmailInput.style('color', '#ffffff');
    highScore1EmailInput.style('font-size', '24px');
    fill(255);
    highScore1NameInput.show();
    highScore1EmailInput.show();
    highScore1NameValue = highScore1NameInput.value();
  ...
  if (frameCount % 8 == 0) { 
    ...
    // Rollover
  if (mouseX > 285 && mouseX < 355 && mouseY > 145 && mouseY < 170){
    stroke(255);
    strokeWeight(2);
    fill(0);
    rect(285,145,70,25);
  ...
  if (mouseIsPressed && mouseX > 285 && mouseX < 355 && mouseY > 145 && mouseY < 170){
    stroke(255);
    strokeWeight(2);
    fill(0);
    rect(285,145,70,25);
  ...
  if (mouseX > 725 && mouseX < 795 && mouseY > 405 && mouseY < 430){
    stroke(255);
    strokeWeight(2);
    fill(0);
    rect(735,407,70,25);
  ...
  if (mouseIsPressed && mouseX > 725 && mouseX < 795 && mouseY > 405 && mouseY < 430){
    stroke(255);
    strokeWeight(2);
    fill(0);
    rect(735,407,70,25);
...
function highScore2page(){
  ...
  fill(0);
  rect(264,126,570,332);
  image(highScore2Image, 550, 290, 600, 350);
  ...
  image(potImages[(currentPotFrame) % numPotFrames], 546, 334, 60, 60);
    ...
    highScore2NameInput.position(485, 385);
    highScore2NameInput.style('background-color',' #000000');
    highScore2NameInput.style('font-size', '28px');
    highScore2NameInput.style('color', '#ffffff');
    highScore2NameInput.style ('font-family', 'VT323','monospace');
    highScore2EmailInput.position(485,415);
    highScore2EmailInput.style('background-color', '#000000');
    highScore2EmailInput.style('font-size', '28px');
    highScore2EmailInput.style('color', '#ffffff');
    highScore2EmailInput.style('font-family', 'VT323','monospace');
    fill(255);
    highScore2NameInput.show();
    highScore2EmailInput.show();
    highScore2NameValue = highScore1NameInput.value();
    highScore2EmailValue = highScore1EmailInput.value();
...
function gameOver() { //the only reason x,y are the only parameters is because they are the only perameters that will change throughout us
    ...
    nameInput.position(280, 350);
    nameInput.style('background-color', '#000000');
    nameInput.style('font-size', '20px');
    nameInput.style('color', '#ffffff');
    nameInput.style('font-family', 'VT323','monospace');
    emailInput.position(280,420);
    emailInput.style('background-color', '#000000');
    emailInput.style('font-size', '20px');
    emailInput.style('color', '#ffffff');
    emailInput.style('font-family', 'VT323','monospace');
    button.position(525, 425);
    button.mousePressed(pushScore);
    fill(255);
    nameInput.show();
    emailInput.show();
    button.show();
...
function pushScore(){
  ...
  ref.push(data);
  fill(255);
  text("Submitted!",height/2, width/2);
  gameState = 10;
}
...
function submitPage(){
    ...
    fill(255);
    text("Submitted. Hit ENTER to Play Again", 490, 250);
    nameInput.hide();
    emailInput.hide();
    button.hide();
