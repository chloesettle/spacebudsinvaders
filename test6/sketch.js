...
function highScore1page(){
  ...
  fill(0);
  rect(550,310,650,400);
  image(highScore1Image,550,310, 650, 400);
  fill(255);
  text(mouseX + "," + mouseY, 560, 320);


  if (mouseIsPressed && mouseX > 310 && mouseX < 380 && mouseY > 210 && mouseY < 230){
    gameState = 2;
  }
...
function highScore2page(){
  ...
  fill(0);
  rect(550,310,650,400);
  image(highScore2Image,560, 320, 650, 400);
  fill(255);
  text(mouseX + "," + mouseY, width/6, height-90);
...
function gameOver() { //the only reason x,y are the only parameters is because they are the only perameters that will change throughout us
    ...
    fill(255);
    text(score, 620, 320);
    text("Enter your email for more gameplay coupons", 490, 390);

    emailInput.position(490,410);
    button.position(700, 410);
