...
function highScore2page(){
  ...
  text("You have earned a reward for your heroic efforts and are hereby formally invited",290, 130);
  text("to compete for the Spacebuds Squadron Elite High score to earn the ultimate badge of honor!",265, 150);
  textSize(16);
  strokeWeight(0);
  fill(0, 255, 0);
